...
from main import DatabaseManager, TelegramBot  # Use your existing classes

db_manager = DatabaseManager()
telegram_bot = TelegramBot()

async def scrape_latest_article():
    """Scrape the first article from Cybernews."""
    ...
    async with async_playwright() as p:
        ...
        first_article = await page.query_selector("div.focus-articles__article_1 a.focus-articles__link")
        if first_article:
...
async def main():
    ...
    if article_info:
        ...
        if link and not db_manager.is_article_sent(link):
            ...
            await telegram_bot.send_message(message)  # This will send to your Telegram
